...
public class ParametersScrollPanelTeaCon extends TScrollPanel {
    ...
    public final TTitledSimpleConstrainedEditBox lifeTime = new TTitledSimpleConstrainedEditBox(
            Component.translatable("gui.mp.de.helper.life"), IntegerArgumentType.integer(0, 100));
    ...
    public final TTitledSimpleConstrainedEditBox amount = new TTitledSimpleConstrainedEditBox(
            Component.translatable("gui.mp.de.helper.amount"), IntegerArgumentType.integer(0, 10));
    ...
    public final TTitledSimpleConstrainedEditBox
            vx = new TTitledSimpleConstrainedEditBox(Component.literal("Vx"), DoubleArgumentType.doubleArg(-1, 1)),
            vy = new TTitledSimpleConstrainedEditBox(Component.literal("Vy"), DoubleArgumentType.doubleArg(-1, 1)),
            vz = new TTitledSimpleConstrainedEditBox(Component.literal("Vz"), DoubleArgumentType.doubleArg(-1, 1)),
            vxD = new TTitledSimpleConstrainedEditBox(Component.translatable("gui.mp.de.helper.vx_diffuse"), DoubleArgumentType.doubleArg(-1, 1)),
            vyD = new TTitledSimpleConstrainedEditBox(Component.translatable("gui.mp.de.helper.vy_diffuse"), DoubleArgumentType.doubleArg(-1, 1)),
            vzD = new TTitledSimpleConstrainedEditBox(Component.translatable("gui.mp.de.helper.vz_diffuse"), DoubleArgumentType.doubleArg(-1, 1));
    //lane 5
    public final TTitledSimpleConstrainedEditBox
            r = new TTitledSimpleConstrainedEditBox(Component.literal("R"), FloatArgumentType.floatArg(0, 10)),
            g = new TTitledSimpleConstrainedEditBox(Component.literal("G"), FloatArgumentType.floatArg(0, 10)),
            b = new TTitledSimpleConstrainedEditBox(Component.literal("B"), FloatArgumentType.floatArg(0, 10));
    ...
    public final TTitledSimpleConstrainedEditBox
            ...
            Component.translatable("gui.mp.de.helper.horizontal_diffuse"), DoubleArgumentType.doubleArg(-2, 2)),
            verticalCollision = new TTitledSimpleConstrainedEditBox(
                    Component.translatable("gui.mp.de.helper.vertical_bounce"), DoubleArgumentType.doubleArg(-2, 2)),
            collisionTime = new TTitledSimpleConstrainedEditBox(
                    Component.translatable("gui.mp.de.helper.collision_time"), IntegerArgumentType.integer(0, 3)),
            xDeflection = new TTitledSimpleConstrainedEditBox(
                    Component.translatable("gui.mp.de.helper.x_deflection"), FloatArgumentType.floatArg(-0.5f, 0.5f)),
            xDeflection2 = new TTitledSimpleConstrainedEditBox(
                    Component.translatable("gui.mp.de.helper.x_deflection_after"), FloatArgumentType.floatArg(-0.5f, 0.5f)),
            zDeflection = new TTitledSimpleConstrainedEditBox(
                    Component.translatable("gui.mp.de.helper.z_deflection"), FloatArgumentType.floatArg(-0.5f, 0.5f)),
            zDeflection2 = new TTitledSimpleConstrainedEditBox(
                    Component.translatable("gui.mp.de.helper.z_deflection_after"), FloatArgumentType.floatArg(-0.5f, 0.5f));
    //lane 7
    ...
    public final TTitledSimpleConstrainedEditBox
            ...
            Component.translatable("gui.mp.de.helper.roll_speed"), FloatArgumentType.floatArg(-0.5f, 0.5f)),
            horizontalInteract = new TTitledSimpleConstrainedEditBox(
                    Component.translatable("gui.mp.de.helper.horizontal_interact"), DoubleArgumentType.doubleArg(-2, 2)),
            verticalInteract = new TTitledSimpleConstrainedEditBox(
                    Component.translatable("gui.mp.de.helper.vertical_interact"), DoubleArgumentType.doubleArg(-2, 2)),
            friction = new TTitledSimpleConstrainedEditBox(
                    Component.translatable("gui.mp.de.helper.friction"), FloatArgumentType.floatArg(0, 1)),
            friction2 = new TTitledSimpleConstrainedEditBox(
                    Component.translatable("gui.mp.de.helper.friction_after"), FloatArgumentType.floatArg(0, 1)),
            gravity = new TTitledSimpleConstrainedEditBox(
                    Component.translatable("gui.mp.de.helper.gravity"), FloatArgumentType.floatArg(-0.5f, 0.5f)),
            gravity2 = new TTitledSimpleConstrainedEditBox(
                    Component.translatable("gui.mp.de.helper.gravity_after"), FloatArgumentType.floatArg(-0.5f, 0.5f));
    //lane 8
    ...
    public final TTitledSimpleConstrainedEditBox
            ...
            alphaBegin = new TTitledSimpleConstrainedEditBox(Component.translatable("gui.mp.de.helper.alpha_begin"), FloatArgumentType.floatArg(0, 1)),
            alphaEnd = new TTitledSimpleConstrainedEditBox(Component.translatable("gui.mp.de.helper.alpha_end"), FloatArgumentType.floatArg(0, 1)),
    ...
    public void setChild(boolean child) {
        ...
        if (child) {
            ...
            lifeTime.getComponent().setArgument(InheritableIntegerArgument.inheritableInteger(0, 100));
            alwaysRender.addElement(InheritableBoolean.INHERIT);
            amount.getComponent().setArgument(InheritableIntegerArgument.inheritableInteger(0, 10));
            Stream.of(xPos, yPos, zPos).forEach(editBox -> editBox.getComponent().setArgument(InheritableVec3Argument.inheritableVec3()));
            Stream.of(vx, vy, vz, vxD, vyD, vzD).forEach(editBox -> editBox.getComponent().setArgument(InheritableDoubleArgument.inheritableDouble(-1, 1)));
            Stream.of(xD, yD, zD).forEach(editBox -> editBox.getComponent().setArgument(Vec3Argument.vec3(false)));
            ...
            collisionTime.getComponent().setArgument(InheritableIntegerArgument.inheritableInteger(0, 3));
            Stream.of(horizontalCollision, verticalCollision, horizontalInteract, verticalInteract).forEach(editBox -> editBox.getComponent().setArgument(InheritableDoubleArgument.inheritableDouble(-2, 2)));
            roll.getComponent().setArgument(InheritableFloatArgument.inheritableFloat(-0.5f, 0.5f));
            interact.addElement(InheritableBoolean.INHERIT);
            Stream.of(r, g, b).forEach(editBox -> editBox.getComponent().setArgument(InheritableFloatArgument.inheritableFloat(0, 10)));
            ...
            lifeTime.getComponent().setArgument(IntegerArgumentType.integer(0, 100));
            alwaysRender.removeElement(InheritableBoolean.INHERIT);
            amount.getComponent().setArgument(IntegerArgumentType.integer(0, 10));
            Stream.of(xPos, yPos, zPos, xD, yD, zD).forEach(editBox -> editBox.getComponent().setArgument(Vec3Argument.vec3()));
            Stream.of(vx, vy, vz, vxD, vyD, vzD).forEach(editBox -> editBox.getComponent().setArgument(DoubleArgumentType.doubleArg(-1, 1)));
