 ...
 * @author USS_Shenzhou
 */
public record MadParticleOption(int targetParticle, MadParticle.SpriteFrom spriteFrom, int amount, double px, double py,
                                double pz, double xDiffuse, double yDiffuse, double zDiffuse, double vx, double vy,
                                ...
                                double horizontalInteractFactor, double verticalInteractFactor, int lifeTime,
                                int renderType, float r, float g, float b, float beginAlpha, float endAlpha,
                                MadParticle.ChangeMode alphaMode, float beginScale, float endScale,
                                MadParticle.ChangeMode scaleMode, boolean alwaysRender) implements ParticleOptions {
